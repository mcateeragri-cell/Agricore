...
export const BUILT_IN_EMAIL_TEMPLATES: BuiltInTemplate[] = [
  ...
  { key: "trial_started", name: "Trial started", category: "Billing", description: "Confirms the Professional trial.", subject: "Your AgriCore trial has started", body: "Your {{trial_days}}-day AgriCore Professional trial for {{company_name}} is active until {{trial_end}}.\n\nYou can manage billing at any time here:\n{{action_url}}" },
