...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    ["/demo", 0.85, "monthly"],
    ["/founding-customers", 0.85, "monthly"],
    ...
    ["/agricultural-engineer-software", 0.9, "monthly"],
    ["/agricultural-crm", 0.9, "monthly"],
    ["/agricultural-invoicing-software", 0.85, "monthly"],
    ["/workshop-scheduling-software", 0.85, "monthly"],
    ["/field-service-management-agriculture", 0.85, "monthly"],
