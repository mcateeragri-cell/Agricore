      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mt-6 grid gap-4 lg:grid-cols-3">
          {[
            ...
            { name: "Enterprise", price: "£149/month + £30/additional depot", detail: "Professional plus Financial Control, enterprise capabilities, API access and priority support.", badge: "Available" },
          ].map((plan) => (
