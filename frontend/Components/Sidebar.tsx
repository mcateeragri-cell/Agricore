...
/* Replace only the existing logo/company header block with: */
...
export default function Sidebar() {
  ...
  const loadCurrentUser = useCallback(async () => {
    ...
    try {
      ...
      if (profileError) {
        console.error(
          "Unable to load sidebar user profile:",
          profileError,
        );
      }
      ...
      if (roleError) {
        console.error(
          "Unable to load sidebar user role:",
          roleError,
        );
      }
      ...
      if (role) {
        ...
        if (permissionsError) {
          console.error(
            "Unable to load sidebar permissions:",
            permissionsError,
          );
        } else {
          permissions =
